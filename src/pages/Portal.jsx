...
function Portal({ user, onLogout }) {
  ...
  const T = {
    ...
    revisionDojo: { en: 'Revision Dojo', zh: '复习道场' },
    ...
    <div className={`portal-page ${lightMode ? 'theme-light' : ''} ${lang === 'zh' ? 'lang-zh' : ''}`}>
      ...
      {helpStep >= 0 && (() => {
        const HELP_STEPS = [
          ...
          { selector: '[data-help="dojo"]', title: 'Revision Dojo', desc: 'Review questions you got wrong. Master cards by getting 3 correct in a row. Earns tokens.' },
